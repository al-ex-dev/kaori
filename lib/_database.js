    ...
    if (m.metadata && m.from.endsWith('@g.us')) {
        ...
        if (chat) {
            ...
            if (typeof chat.antilink !== 'object') chat.antilink = {
                status: false,
                platforms: {
                    youtube: { status: true, urls: ["youtube.com", "youtu.be"] },
                    facebook: { status: true, urls: ["facebook.com", "fb.com", "fb.me"] },
                    instagram: { status: true, urls: ["instagram.com", "ig.me"] },
                    tiktok: { status: true, urls: ["tiktok.com", "vm.tiktok.com"] },
                    twitter: { status: true, urls: ["twitter.com", "t.co", "x.com"] },
                    reddit: { status: true, urls: ["reddit.com", "redd.it"] },
                    pinterest: { status: true, urls: ["pinterest.com", "pin.it"] },
                    snapchat: { status: true, urls: ["snapchat.com", "sc.snapchat.com"] },
                    telegram: { status: true, urls: ["t.me", "telegram.dog"] },
                    whatsapp: { status: true, urls: ["whatsapp.com", "wa.me", "wa.link"] },
                    discord: { status: true, urls: ["discord.com", "discord.gg"] },
                    spotify: { status: true, urls: ["spotify.com", "spoti.fi"] }
                }
            }
