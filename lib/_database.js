        ...
        if (chat) {
            ...
            if (typeof chat.antilink !== 'object') chat.antilink = {
                ...
                platforms: {
                    ...
                    facebook: { status: false, urls: [ 'facebook.com', 'fb.com' ] },
                    instagram: { status: false, urls: [ 'instagram.com', 'ig.com' ] },
                    tiktok: { status: false, urls: [ 'tiktok.com', 'tt.com' ] },
                    twitter: { status: false, urls: [ 'twitter.com', 't.co' ] },
                    reddit: { status: false, urls: [ 'reddit.com', 'redd.it' ] },
                    pinterest: { status: false, urls: [ 'pinterest.com', 'pinterest.it' ] },
                    snapchat: { status: false, urls: [ 'snapchat.com', 'snapchat.it' ] },
                    telegram: { status: false, urls: [ 't.me', 'telegram.me' ] },
                    whatsapp: { status: false, urls: [ 'whatsapp.com', 'wa.me' ] },
                }
            }
